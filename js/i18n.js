  ...
  constructor(store) {
    ...
    this.translations = {
      ru: {
        ...
        deposits_modal_sub: 'Активные сделки можно открыть повторно до истечения времени. Отменённые сделки не содержат подробностей.',
      ...
      en: {
        ...
        deposits_modal_sub: 'Active pending deals can be reopened before the timer expires. Cancelled deals contain no details.',
