  ...
  constructor(store) {
    ...
    this.translations = {
      ru: {
        ...
        admin_xpub_title: '🔐 Настройки HD-кошелька (Master Public Key — xPub)',
        ...
        modal_topup_desc: '1 Орб = 1 USDT. Оплата происходит прямым переводом на уникальный адрес вашего заказа, сгенерированный HD-кошельком (xPub).',
        modal_topup_amount: 'Количество Орбов',
        modal_topup_network: 'Сеть перевода USDT',
        modal_topup_order: 'Заказ:',
        modal_topup_to_pay: 'К оплате:',
        modal_topup_address: 'Адрес для перевода',
        modal_topup_copy: '📋 Копия',
        modal_topup_derivation: 'Деривация:',
      ...
      en: {
        ...
        admin_xpub_title: '🔐 HD-Wallet Configuration (Master Public Key — xPub)',
        ...
        modal_topup_desc: '1 Orb = 1 USDT. Payments are sent directly to a unique order address generated by your HD-wallet (xPub).',
        modal_topup_amount: 'Orbs Amount',
        modal_topup_network: 'USDT Network',
        modal_topup_order: 'Order:',
        modal_topup_to_pay: 'To Pay:',
        modal_topup_address: 'Deposit Address',
        modal_topup_copy: '📋 Copy',
        modal_topup_derivation: 'Derivation:',
